  ...
  <q-page v-cloak class="bg-white">
    ...
    <div class="q-pa-md">
      <div class="row flex-center">
        <div :class="isMobile ? 'col-12 col-md-12 ' : 'col-12 col-md-7'">
          <Highmaps
            ref="Highcharts"
        ...
        <div :class="isMobile ? 'col-12 col-md-12 ' : 'col-12 col-md-4'">
          ...
          <div class="col-12 col-md-12">
            <div class="col-12 col-md-12">
              <div class="row justify-center">
                <div class="col-12 text-center">
                  <label class="text-primary text-h6">Centros</label>
                </div>
              </div>
              <q-list dense bordered separator>
                ...
                <div v-else class="flex-center">
                  <label>No hay centros en el departamento seleccionado</label>
                </div>
              </q-list>
            </div>
            ...
            <div class="col-12 col-md-12">
              <div class="row justify-center">
                <div class="col-12 text-center">
                  <label class="text-primary text-h6">Cursos</label>
                </div>
              </div>
              <q-list dense bordered separator>
  ...
  methods: {
    CargarCursos(idCentro) {
      ...
      axios({
        ...
        .then(response => {
          console.log({ idCentro, cursos: response.data.cursos })
    ...
    DistribucionXCentros() {
      ...
      axios({
        ...
        .then(response => {
          ...
          console.log({ pieChart: this.$refs.pieChart.chart })
