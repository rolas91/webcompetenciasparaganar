    ...
    <div class="q-pa-md q-gutter-md">
      <div class="row q-gutter-md">
        ...
        <q-btn
          ...
          class="bg-primary text-white"
          :to="`/catalogos/cursos/${this.selected[0].id}/ver`"
        >
          Ver
        </q-btn>
        <q-btn
          ...
          class="bg-primary text-white"
          :to="`/catalogos/cursos/${this.selected[0].id}/editar`"
        >
          Editar
        </q-btn>
        <q-btn
        ...
        <q-btn
          ...
          :to="`/admin/cursos/${this.selected[0].id}/inscripciones`"
        >
          inscripciones
        </q-btn>
        ...
        <!-- <q-checkbox v-model="mostrar_importado"  label="Mostrar datos importados" @click="CargarCursos" /> -->
      </div>
...
export default {
  ...
  methods: {
    ...
    eliminarCurso() {
      var url = process.env.API_URL + '/catalogos/cursos/' + this.selected[0].id
    ...
    CargarCursos(props) {
      ...
      var url = process.env.API_URL + '/catalogos/cursos/index'
      ...
      axios({
        ...
        .then((response) => {
          ...
          this.cursos = response.data.catalogo_cursos.data
          this.loadingCursos = false

          this.cursos = response.data.catalogo_cursos.data
          this.loading = false
          this.loadingCursos = false
          this.pagination.rowsNumber = response.data.catalogo_cursos.total
          this.pagination.rowsPerPage = rowsPerPage
          this.pagination.page = response.data.catalogo_cursos.current_page
        })
        .catch((error) => {
          console.log({ error })
          this.loadingCursos = false
